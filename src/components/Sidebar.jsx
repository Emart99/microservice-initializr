            ...
            <div id="hs-sidebar-basic-usage" className="hs-overlay 
                ...
                <div className="relative flex flex-col h-full max-h-full ">
                    <header className="py-4 flex justify-center items-center">
                        <img src={SpringIcon} className="" alt="My SVG" />

                        <p className="flex-none font-semibold text-xl text-black focus:outline-hidden focus:opacity-80 p-3 dark:text-white" href="#" aria-label="Brand">
